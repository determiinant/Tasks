/*
Ввести рік, місяць, день, години, хвилини, секунди. 
Порахувати скільки пройшло секунд з початку року (обчислення у функції). 

Доп умови: 
Зробити підтвердження чи ввід правильний "Так" "Ні" після вводу всіх даних, також перевірити їх на правильність вводу
*/
#include <iostream>
#include <map>
using namespace std;
