/*Умова:
Створити клас Human, який має такі privat змінні:
age, height, name.
Через конструктор класа, створити стандартну людину, потім ввести дані для своєї людини, 
встановити їх set-методами, і вивести її дані через get-медоти.
*/
#include <iostream>
#include <string>
using namespace std;
